...
@router.get("/db-stats")
async def database_statistics(db: Session = Depends(get_db),current_user: User = Depends(get_current_user)):
    """
    ...
    try:
        ...
        tables = ["users", "products", "plants", "accessories", "plant_guides", "orders"]
